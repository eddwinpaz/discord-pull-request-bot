...
async function takeScreenshot(url) {
    try {
        ...
        const browser = await puppeteer.launch({ headless: "true", userDataDir: '/Users/lpaz/Library/Application Support/Google/Chrome/Default' });
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.commandName === 'pr-front') {
        ...
        try {
            ...
            const file = '/Users/lpaz/Desktop/discord/' + screenshot
